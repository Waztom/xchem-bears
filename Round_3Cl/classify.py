...
miss_df.CompoundSMILES = rdkit_utils.standardise_SMILES(list(miss_df.CompoundSMILES))
...
# Need to standardise SMILES
hit_df.CompoundSMILES = rdkit_utils.standardise_SMILES(list(hit_df.CompoundSMILES))
